...
#define ll_wrn \
"Warning -239:  Parallel retrieval is not supported for this type of data.\n\n"
#define llrtv_dir_wrn \
"Warning -240:  Parallel retrieval not supported for directories. \n\n"
#define llrtv_files_wrn \
"Warning -241:  Parallel retrieval not supported for groups of files. \n\n"
#define llrtv_5mb_wrn  \
"Warning -242:  Parallel retrieval is not supported for data \n\
               less than 5 Mb in size.\n\n"
#define ll_zip_wrn \
"Warning -243:  Parallel transfer supported only for zipped data.\n\n"
#define ll_dir_wrn \
"	Warning -244:  Parallel transfer is not supported for directories.\n\n"
#define ll5mb_wrn  \
...
#define disk_err "error -264:  There is not enough disk space available on your \n\
               machine for data retrieval.  %d bytes are \n\
               available, and %d bytes are required.\n\n\
               To continue file retrieval anyway, type 'y'\n\
               To abort file retrieval, type 'n'  "
#define DISK_ERR -264
...
"Error -269:    A file name was not specified.  You must \n\
...
%s\n\n\
%s"
#define ARCHIVE_WRITE_DATA_ERR -281
