...
#define encryption_auth_err "Error -507:    You are not authorized to access\n\
               data with personal secure keyword '%s'.\n\n\
               Only the customer who received the sender email message from the\n\
               containing the personal secure keyword can use the keyword to\n\
               access the data.\n\n\
The keyword was sent to: %s.\n\n\
Your registered e-mail addresses at the %s site are:\n\n\
Primary email address:  %s\n\
Secondary e-mail address: %s"
...
#define trans_lock_wrn "\n\nWarning -515:  You have entered an invalid keyword 6 consecutive\n\
               times.  If you enter another invalid keyword, you\n\
               will be locked out of Transcend."
#define intercom_lock_wrn "\n\nWarning -515:   You have entered an invalid keyword 6 consecutive\n\
               times.  If you enter another invalid keyword, you\n\
               will be locked out of InterCom."
#define LOCK_WRN -515
...
#ifdef TRANSCEND
#define disk_err "Error -523:  There is no more disk space available in the Transcend repository."
#endif
#ifdef TRANSWEB
#define disk_err "Error -523:  There is no more disk space available in the TransWeb repository."
#endif
#ifdef INTERCOM
#define disk_err "Error -523:  There is no more disk space available in the InterCom repository."
#endif
#define DISK_ERR -523
...
#define internet_get_err "Warning -545:  Data cannot be retrieved from this TransNet site."
#define INTERNET_GET_ERR -545
#define no_keyword_wrn "Warning -546:  No personal secure keywords found for '%s' on the %s repository"
...
#define user_reg_err "Error -551:    Registration cannot be performed because you are logged in under another user's NXP Semiconductor ID.\n\n\
               Your core ID:  %s\n\
...
"Error -563:    Your transaction was aborted because an e-mail address for\n\
               ...
               customer,  select 'External TransWeb  Customer  as  the\n\
               receiving repository or upload the data using the\n\
...
"Warning -580:  You must use the last version of Transcend to transfer data to DTMS:\n\
...
#define stat_err "Error -582:    Unable to access:\n\n\
               File:  '%s'"
#define STAT_ERR -582
