...
#define SWIG_init    boot_example

#define SWIG_name   "examplec::boot_example"
#define SWIG_prefix "examplec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_example_var::
class _wrap_example_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
SWIGCLASS_STATIC int _wrap_My_variable_set(pTHX_ SV* sv, MAGIC * SWIGUNUSEDPARM(mg)) {
  MAGIC_PPERL
  {
    double val;
...
SWIGCLASS_STATIC int _wrap_My_variable_get(pTHX_ SV *sv, MAGIC *SWIGUNUSEDPARM(mg)) {
  MAGIC_PPERL
  sv_setsv(sv,SWIG_From_double  SWIG_PERL_CALL_ARGS_1((double)(My_variable)))  ;
  return 1;
}
...
XS(_wrap_icom_put_compress_init) {
  {
    int arg1 ;
    char *arg2 = (char *) 0 ;
    char *arg3 = (char *) 0 ;
    ...
    arg3 = &temp3;
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: icom_put_compress_init(delete,msg_ptr);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
      SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "icom_put_compress_init" "', argument " "1"" of type '" "int""'");
    } 
    arg1 = (int)(val1);
    res2 = SWIG_AsCharPtrAndSize(ST(1), &buf2, NULL, &alloc2);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "icom_put_compress_init" "', argument " "2"" of type '" "char *""'");
    }
    arg2 = (char *)(buf2);
    icom_put_compress_init(arg1,arg2,arg3);
...
XS(_wrap_printmsg) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: printmsg();");
    }
    result = (char *)printmsg();
    ST(argvi) = SWIG_FromCharPtr((const char *)result); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
...
static swig_variable_info swig_variables[] = {
    { "examplec::My_variable", MAGIC_CLASS _wrap_My_variable_set, MAGIC_CLASS _wrap_My_variable_get,0 },
{0,0,0,0}
};
static swig_command_info swig_commands[] = {
{"examplec::fact", _wrap_fact},
{"examplec::my_mod", _wrap_my_mod},
{"examplec::get_time", _wrap_get_time},
{"examplec::icom_put_compress_init", _wrap_icom_put_compress_init},
{"examplec::printmsg", _wrap_printmsg},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
